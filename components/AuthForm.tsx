...
import { Loader2, Mail, Lock, UserPlus, LogIn, AlertCircle, CheckCircle2, KeyRound, User } from 'lucide-react';
        ...
        <Tabs value={activeTab} onValueChange={(v) => {
          ...
          <TabsContent value="signin" className="mt-6 space-y-5">
            ...
            <Button
              ...
              className="w-full h-12 border-slate-600 bg-white hover:bg-gray-50 dark:bg-slate-800 dark:hover:bg-slate-700 flex items-center justify-center gap-3 transition-all"
            >
              {oauthLoading === 'google' ? (
                ...
                <>
                  ...
                  <span className="text-slate-700 dark:text-slate-200 font-medium">سجل دخول باستخدام جوجل</span>
                </>
              )}
            </Button>
          ...
          <TabsContent value="signup" className="mt-6 space-y-5">
            ...
            <form onSubmit={signUpForm.handleSubmit(handleSignUp)} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="signup-name" className="text-slate-200 flex items-center gap-2">
