                ...
                <div key={sectionKey} className="mb-20">
                  ...
                  <div className={isPackageSection ? "grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8" : "grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6"}>
                    ...
                    if (isPackageSection && product.isPackage) {
                      return (
                        <Link key={product.id} href={`/subscribe/${product.code}`}>
                          <Card className="group relative overflow-hidden bg-gradient-to-br from-slate-800/90 to-slate-900/90 border-2 border-slate-700/50 hover:border-slate-500 transition-all duration-300 hover:shadow-2xl hover:shadow-amber-500/20 hover:-translate-y-2 h-full flex flex-col">
                            {/* Gradient overlay */}
                            <div className={`absolute inset-0 bg-gradient-to-br ${product.gradient} opacity-0 group-hover:opacity-15 transition-opacity duration-300`} />
                    ...
                    return (
                      <Link key={product.id} href={`/subscribe/${product.code}`}>
                        <Card className="group relative overflow-hidden bg-gradient-to-br from-slate-800/90 to-slate-900/90 border border-slate-700/50 hover:border-slate-600 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-1 h-full flex flex-col">
                          {/* Gradient overlay */}
                          ...
                          {/* Product Image */}
                          <div className="relative h-32 md:h-48 w-full overflow-hidden bg-gradient-to-br from-slate-700 to-slate-800">
